<template>
  ...
  @dragover.prevent
  @dragenter.prevent>
    <div v-bind:key="currentBook.isbn" v-bind:class="{new_book: isNewBook(currentBook)}" v-for="currentBook in booksList" draggable @dragstart="startDrag($event, currentBook)"
